...
<div class="header">
    ...
    <div class="image"><img src="${actionBean.socialMediaUser.imageURL}"/></div>
    <div class="text1">${actionBean.socialMediaUser.realName} - @${actionBean.socialMediaUser.screenName}</div>
    <div class="text2">${actionBean.socialMediaUser.description}</div>
</div>
</div>
...
<div class="main">
	...
	${actionBean.socialMediaUser.activationDate}<br>
	${actionBean.socialMediaUser.postCount}<br>
	${actionBean.socialMediaUser.followers}<br>
	${actionBean.socialMediaUser.friends}<br>
	</div>
...
<stripes:param name="userId" value="${actionBean.socialMediaUser.id}"/>
</stripes:link>
</div>
</div>
</body>
